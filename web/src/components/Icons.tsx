...
/** The mark in the header: a feather stroke inside the lime tile. */
export function LogoMark({ size = 20 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" fill="none" aria-hidden="true">
      <path
        d="M14 52c0-16 8-27 20-32-6 7-9 14-10 21 6-7 14-11 24-12-4 14-14 23-26 23h-8z"
        fill="#000"
      />
      <path d="M14 52L40 22" stroke="#000" strokeWidth={4} strokeLinecap="round" />
    </svg>
  );
}
...
export const SpinnerIcon = ({ size = 18, ...p }: IconProps) => (
  <Icon size={size} className="spin" {...p}>
